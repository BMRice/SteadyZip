...
internal static class FormatIds
{
    ...
    /// <summary>RAR5 is a separate handler from RAR4 in 7z.dll; the RAR4 handler cannot read
    /// RAR5 at all (it opens "successfully" with zero items). Same extension, so the only way
    /// to tell them apart is the file signature — see <see cref="FormatDetection.GetClsidForOpen"/>.</summary>
    internal static readonly Guid Rar5 = new(0x23170F69, 0x40C1, 0x278A, 0x10, 0x00, 0x00, 0x01, 0x10, 0xCC, 0x00, 0x00);
    ...
    internal static readonly Guid BZip2 = new(0x23170F69, 0x40C1, 0x278A, 0x10, 0x00, 0x00, 0x01, 0x10, 0x02, 0x00, 0x00);
